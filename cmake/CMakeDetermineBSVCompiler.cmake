...
if(NOT CMAKE_BSV_COMPILER_INIT)
  set(CMAKE_BSV_COMPILER_LIST ${CMAKE_CURRENT_LIST_DIR}/drivers/bsvc)
endif()

_cmake_find_compiler(BSV)
mark_as_advanced(CMAKE_BSV_COMPILER)

set(CMAKE_AR ${CMAKE_CURRENT_LIST_DIR}/drivers/bsvar)
set(CMAKE_BSV_LINKER ${CMAKE_CURRENT_LIST_DIR}/drivers/bsvlink)
