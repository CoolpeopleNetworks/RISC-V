function(add_bsim_testbench TARGET SOURCE)
    ...
    add_custom_target(
        ${TARGET} ALL
        DEPENDS ${ARGN}
        COMMAND bsc ${BSC_COMMON_FLAGS} ${BSC_DEFINES} -sim -q -u -bdir "${CMAKE_CURRENT_BINARY_DIR}" -p "%/Libraries:${CMAKE_CURRENT_SOURCE_DIR}:${BSV_MODULE_DIRS}" -o "${CMAKE_CURRENT_BINARY_DIR}/${TARGET}" "${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE}"
        COMMAND bsc ${BSC_COMMON_FLAGS} ${BSC_DEFINES} -sim -q -u -e mk${TARGET} -bdir "${CMAKE_CURRENT_BINARY_DIR}" -p "${CMAKE_CURRENT_SOURCE_DIR}:${BSV_MODULE_DIRS}" -o "${CMAKE_CURRENT_BINARY_DIR}/${TARGET}"
    )
